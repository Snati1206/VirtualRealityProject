...
#define Broche_Trigger_1 2// Broche Trigger du HC-SR04 sur D8 //
#define Broche_Echo_2 8
#define Broche_Trigger_2 7
...
digitalWrite(Broche_Trigger_1, LOW); // On efface l'etat logique de TRIG //
delayMicroseconds(2);
